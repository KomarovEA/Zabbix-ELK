...
#Set Multipart Config in Web.xml our app (/opt/tomcat/webapps/TestApp/WEB-INF/web.xml ):
...
EOFWB
# CONFIGURING TOMCAT JMX/RMI LISTENER
wget -nc -P /opt/tomcat/lib/ http://ftp.byfly.by/pub/apache.org/tomcat/tomcat-8/v8.5.47/bin/extras/catalina-jmx-remote.jar
sed 's|<Listener className="org.apache.catalina.core.ThreadLocalLeakPreventionListener" />|<Listener className="org.apache.catalina.core.ThreadLocalLeakPreventionListener" />\n<Listener className="org.apache.catalina.mbeans.JmxRemoteLifecycleListener"\nrmiRegistryPortPlatform="8097"\nrmiServerPortPlatform="8098"\n/>|' -i /opt/tomcat/conf/server.xml
